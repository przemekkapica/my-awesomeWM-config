...
globalkeys = my_table.join(
    ...
    -- Session keybindings
   	awful.key({ modkey, "Shift" }, "e", function () awful.util.spawn( "pkill -KILL -u przemek" ) end,
        {description = "log out" }),
    awful.key({ modkey, "Shift" }, "b", function () awful.util.spawn( "reboot" ) end,
...
awful.rules.rules = {
    ...
    -- Assign users' applications to workspaces/screens
    { rule = { class = "Nemo" },
